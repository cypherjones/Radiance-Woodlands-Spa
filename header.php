<?php 
  ...
  <!-- End Google Tag Manager (noscript) -—>
    ...
    <header id="header">
    <div class="container">
      <div class="logo pull-left"><a href="<?php bloginfo('url' ); ?>"><img src="<?php bloginfo('template_directory' ); ?>/images/RADIANCE_NEW-LOGO-transparent_small.png" alt="Medical Aesthetics and Wellness"></a></div>
